...
public class TestGarage {
	...
	@Test
	public void addMultipleVehicles_IsValidIfNoCarsInGarage() {
	...
	@Test
	public void addMultipleVehicles_IsValidIfCarsInGarage() {
		Garage operator = new Garage();
		ArrayList<Vehicle> toAdd = new ArrayList<Vehicle>();
	...
	@Test
	public void AvaragefuelPer100Km_IsValid() {
		Garage operator = new Garage();
		ArrayList<Vehicle> toAdd = new ArrayList<Vehicle>();
	...
	@Test
	public void addVehicle_WorksForEmptyGarage() {
		Garage operator = new Garage();
	...
	@Test
	public void addVehicle_WorksIfVehiclesInGarage() {
		Garage operator = new Garage();
		Vehicle toAdd = new Truck("B5662BM",500,250);
		ArrayList<Vehicle> toAdd2 = new ArrayList<Vehicle>();
